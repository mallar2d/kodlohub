  ...
  return (
    <div ref={ref} className={`relative ${fullWidth ? "w-full" : ""}`}>
      <button
        ...
        className="w-8 h-8 rounded-full flex items-center justify-center border border-hairline-dark hover:border-white/40 text-on-primary-mute hover:text-on-primary bg-canvas-night-soft/60 hover:bg-canvas-night-soft transition-all relative cursor-pointer"
