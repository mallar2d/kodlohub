...
export default function Navbar() {
  ...
  return (
    <>
              ...
              <div className="relative" data-user-menu>
                ...
                {userMenuOpen && (
                  <div className="absolute right-0 top-full mt-2 w-56 max-h-[calc(100dvh-5rem)] overflow-y-auto bg-canvas-night-soft border border-hairline-dark rounded-lg shadow-xl z-50 py-2">
                    ...
                    <p className="px-4 pt-2 pb-1 micro-cap text-ink-mute">
                      Посилання
                    </p>
      ...
      {/* Mobile menu lives outside the blurred navbar so opening it does not expand
        a backdrop-filter layer or lock the document scroll on mobile browsers. */}
      {menuOpen && (
        <div
          className="lg:hidden fixed inset-x-0 top-[57px] bottom-0 z-50 bg-canvas-night border-t border-hairline-dark px-4 sm:px-6 py-5 overflow-y-auto overflow-x-hidden overscroll-contain"
          role="dialog"
          aria-modal="true"
