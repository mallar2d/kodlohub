        ...
        <div className="grid lg:grid-cols-[1.1fr_1fr] gap-8 animate-slide-up">
          ...
          <div className="card-dark p-6 sm:p-10 flex flex-col">
            ...
            <div className="prose text-on-primary-mute text-sm flex-1 mb-8">
              <p>
                Ласкаво просимо на **Національний Мультипредметний Тест про Подро** — головного мем-персонажа ФІКТ,
                легенду Коростишева та біологічну зброю масового ураження.
              </p>
              <p>
                Тест повністю базується на офіційних розсекречених матеріалах з файлу `подро.txt`.
              ...
              <ul className="list-disc pl-5 flex flex-col gap-2">
                <li>**Кількість завдань**: 40 (30 тестів, 5 відповідностей, 5 виборів 3 із 7).</li>
                <li>**Максимальний бал**: 65 балів (конвертуються в оцінку від 100 до 200).</li>
                <li>**Час**: необмежений, але швидкість проходження вирішує суперечки в лідерборді при рівній кількості балів.</li>
                <li>
                  **Спроба на оцінку**: тільки **ОДИН РАЗ**. Результат одразу запишеться в лідерборд.
